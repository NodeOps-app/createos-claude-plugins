...
**`cos vpn up` blocks the shell until you disconnect** — run it yourself in a separate terminal (type `!cos vpn up` in the Claude prompt, or run it directly), not as a foreground agent command.
